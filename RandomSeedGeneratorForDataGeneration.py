...
def main():
    # --- CONFIGURATION ----------------
    py_script = "SmartFRZCombinedOperation.py"
    name_of_experiment = "mambafrz_all_conv_dataset_generation"
    fully_trained_reference_model = f"test_model_weights/best_model_test.pt"
    window_size = 30
