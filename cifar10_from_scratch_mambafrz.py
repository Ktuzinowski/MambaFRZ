...
if __name__ == "__main__":
    ...
    predictor_path = "mambafrz_20_conv_seed_25_experiment_same_seed_reference/training_data_0.0004_var_thresh/context_window_30/checkpoints_exp/mambafrz_trained_0.pth"
