...
def main():
    # --- CONFIGURATION ----------------
    py_script = "SmartFRZCombinedOperation_VGG16.py"
    name_of_experiment = "mambafrz_vgg16_data_generation"
    fully_trained_reference_model = f"test_model_weights/best_model_VGG16.pt"
    window_size = 30
