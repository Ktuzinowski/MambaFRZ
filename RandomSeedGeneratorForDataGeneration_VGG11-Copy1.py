...
def main():
    ...
    name_of_experiment = "mambafrz_vgg11_SmartFRZ_validation_12_seeds_post_processing"
    fully_trained_reference_model = f"test_model_weights/best_model_VGG11.pt"
    window_size = 30
    frz_predictor_path = "/home/idies/workspace/Storage/ktuzinows1/persistent/MambaFRZ/mambafrz_vgg11_data_generation_12_seeds/training_data/context_window_30/smartfrz_small_test/smartfrz_6.pth"
    ...
    num_epochs = 200
    frz_predictor_model_name = "smartfrz"
    # ----------------------------------
